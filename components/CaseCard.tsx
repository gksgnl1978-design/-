...
const CaseCard: React.FC<CaseCardProps> = ({ data }) => {
  ...
  return (
    <article className={`bg-white rounded-[2.5rem] shadow-xl ${themeClasses.shadow} border ${themeClasses.border} overflow-hidden transition-all hover:scale-[1.01] hover:shadow-2xl`}>
      <div className="grid md:grid-cols-[1fr_1.8fr] min-h-[320px]">
        {/* Left: Stats */}
        <div className={`p-8 ${themeClasses.bg} flex flex-col justify-center border-r ${themeClasses.border}`}>
          <div className="mb-6">
        ...
        <div className="p-8 md:p-12 flex flex-col justify-center bg-white">
          ...
          <div className="relative">
            <Quote className={`absolute -top-6 -left-6 w-12 h-12 ${themeClasses.quote} opacity-70`} />
